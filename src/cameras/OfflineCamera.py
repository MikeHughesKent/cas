...
class OfflineCamera(GenericCameraInterface):
    ...
    def __str__(self):
        return "Offline Camera, source = " + self.filename  
    ...
    def get_image(self):
       ...
       if self.preLoaded:
           ...
           imData = np.array(self.dataset.getdata()).reshape(self.dataset.size[1], self.dataset.size[0])
